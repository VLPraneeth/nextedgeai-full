...
import { ColumnItem } from './ConfigureTableColumnsModal';
                            ...
                            <HStack justify="space-between">
                              <HStack>
                                ...
                                <div className="column-label">
                                  {labelForColumn(column.columnName)} ({column.columnName})
                                </div>
                              </HStack>
                              ...
                              <HStack className="actions">
                                ...
                                <div
                                  ...
                                  className={cx('drag-handle', isDragDisabled && 'disabled')}>
                                  <CaretUp className="move_one_up_icon" onClick={() => moveOneUp(index)} />
                                  <MenuIcon />
                                  <CaretDown className="move_one_down_icon" onClick={() => moveOneDown(index)} />
                                </div>
                              </HStack>
                            </HStack>
                          </li>
