...
import { rendererWrapper as TransactionChangesRenderer } from './data-studio-transaction-record-details/TransactionChangesRenderer';
import { rendererWrapper as TransactionErrorsRenderer } from './data-studio-transaction-record-details/TransactionErrorsRenderer';
...
import DataStudioLineagePanel from './DataStudioLineagePanel';
  ...
  const columns = useMemo<ColDef[]>(() => {
    const columnDefs = [
      ...
      },
      {
        ...
        colId: 'changes',
        field: 'changes',
        cellClass: 'data-studio-transactions-table-synri-changes-column',
  ...
  return (
    <>
      <TransactionContextProvider>
        <AgTable
          ...
          pagerComponent={
            <CursorBasedPagination
              ...
              pageSize={pageSize}
              isLoading={isLoading}
              currentRecordCount={rowData.length}
        ...
        <DataStudioLineagePanel onRequestClose={onRequestCloseTransactionDetail} transaction={showTransactionDetail} />
      </TransactionContextProvider>
    </>
  );
};
