...
export interface EnhancedModalProps extends Omit<AntModalProps, 'afterClose' | 'onCancel' | 'visible'> {
  children: React.ReactNode;
}

export const EnhancedModal = ({ children, ...props }: EnhancedModalProps) => {
  const { modalProps } = useOperationModalContext();
  return (
    <AntModal className="synri-batch-operation-modal" width={700} {...props} {...modalProps}>
