...
public abstract class AbstractSyncariTest {
    ...
    public void setUp() {
        ...
        if (!dbSetup) {
            ...
            log.info("connectorService : {}, datastoreService : {} instance : {}", connectorService, datastoreService, instance);
            connectorService.setStatus(datastoreService.createOrGetSyncariDSConnector(instance.getSyncariId()).getId(), ConnectorStatus.ACTIVE,null,null);
    ...
    protected void withContext(Runnable runnable) {
        restoreContext();
        try {
            runnable.run();
        } finally {
