...
public class OraclePIMListBasedIterator implements EntityDataBatchIterator {
    List<EntityData> filteredRecords;
    boolean consumed = false;
    private WatermarkInfo watermark;

    public OraclePIMListBasedIterator(List<EntityData> records, WatermarkInfo watermark) {
