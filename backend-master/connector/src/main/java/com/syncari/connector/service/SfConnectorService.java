...
@Slf4j
@Component(Constants.SF_MARKETING_CLOUD)
public class SfConnectorService implements CommonDataService, MetadataService, SynapseInfoService {
    @Autowired
    ...
    public String getName() {
        return Constants.SF_MARKETING_CLOUD;
    }

    public UIMetadata getUIMetadata() {
        return new UIMetadata().setIconPath("/assets/icons/logos/sfcloud.svg")
                .setDisplayName("Salesforce Marketing Cloud")
