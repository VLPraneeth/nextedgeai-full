...
@Slf4j
@Component(Constants.KINESIS)
public class KinesisService  implements CommonDataService, MetadataService, SynapseInfoService {
    @Autowired
    ...
    public String getName() {
        return Constants.KINESIS;
    }

    public UIMetadata getUIMetadata() {
        return new UIMetadata().setIconPath("/assets/icons/logos/kinesis.svg")
                .setDisplayName("Amazon Kinesis")
                .setBackgroundColor("#FFF6EF")
