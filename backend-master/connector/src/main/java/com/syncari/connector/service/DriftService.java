...
@Slf4j
@Component(Constants.DRIFT)
public class DriftService implements CommonDataService, MetadataService, SynapseInfoService {
    @Autowired
    ...
    public String getName() {
        return Constants.DRIFT;
    }

    public UIMetadata getUIMetadata() {
        return new UIMetadata().setIconPath("/assets/icons/logos/drift.svg")
                .setDisplayName("Drift")
