...
public class AddToMarketoListActionTest extends AbstractSyncariTest {

    @Autowired
    AddToMarketoListAction action;
    ...
    public void validate(){
        ...
        MappingGraph entityGraph = newGraph(coreEntity, null, actionDefinitionRepo)
                .src(srcEntity)
                .action("addToMarketoList", "Add To List")
                .connect("srcAccount", "coreAccount")
                .connect("coreAccount", "Add To List").getGraph();

        MappingNode actionNode = entityGraph.findNodeByName("Add To List").get();
        ...
        try{
            ...
            assertEquals("Missing Synapse from Add To List in graph coreAccount", e.getMessage());
        }
        ...
        try{
            ...
            assertEquals("Missing List Id from Add To List in graph coreAccount", e.getMessage());
        }
        ...
        try{
            ...
            assertEquals("Missing Lead Id from Add To List in graph coreAccount", e.getMessage());
        }
        ...
        try{
            ...
            assertEquals("Invalid Synapse 'INVALID' in node Add To List of graph coreAccount", e.getMessage());
        }
        ...
        try{
            ...
            assertEquals("Invalid Synapse 'sfdc' in node Add To List of graph coreAccount", e.getMessage());
        }
        ...
        try{
            ...
            assertEquals("Invalid List Id 'abc' in node Add To List of graph coreAccount", e.getMessage());
        }
        ...
        try{
            ...
            assertEquals("Connector mkto doesn't have a List with id 1 defined in node Add To List of graph coreAccount", e.getMessage());
        }
        ...
        try{
            ...
            assertEquals("Invalid Lead Id 'abc' in node Add To List of graph coreAccount", e.getMessage());
        }
