...
public class M0085_InsightsDatasetDatacardSeedV2 {
    ...
    @ChangeSet(order = "001", id = "quarterlyClosedPipelineRevenueDS", author = "rohit")
    ...
    @ChangeSet(order = "002", id = "quarterlyClosedPipelineRevenueDC", author = "rohit")
    ...
    @ChangeSet(order = "003", id = "yearlyClosedPipelineRevenueDS", author = "rohit")
    ...
    @ChangeSet(order = "004", id = "annualRecurringRevenueDC", author = "rohit")
    ...
    @ChangeSet(order = "005", id = "nextFewQuaterOpenPipelinesDS", author = "rohit")
    ...
    @ChangeSet(order = "006", id = "nextFewQuaterOpenPipelinesDC", author = "rohit")
    ...
    @ChangeSet(order = "007", id = "allOpenPipelineByTypeDS", author = "rohit")
    ...
    @ChangeSet(order = "008", id = "allOpenPipelineByTypeDC", author = "rohit")
    ...
    @ChangeSet(order = "009", id = "salesFunnelDS", author = "rohit")
    public void salesFunnelDS(MongoTemplate template){
        try{
            ...
            config.setProjectionsList(List.of(countProjection,closedate,stageProjection));
    ...
    @ChangeSet(order = "010", id = "salesFunnelDC", author = "rohit")
    ...
    @ChangeSet(order = "011", id = "openRenewalLogoCountDS", author = "rohit")
    ...
    @ChangeSet(order = "012", id = "openRenewalLogoCountDC", author = "rohit")
    ...
    @ChangeSet(order = "013", id = "upcomingRenewalDatesDS", author = "rohit")
    ...
    @ChangeSet(order = "014", id = "upcomingRenewalDatesDC", author = "rohit")
    ...
    @ChangeSet(order = "015", id = "openRenewalsDS", author = "rohit")
    ...
    @ChangeSet(order = "016", id = "openRenewalsDC", author = "rohit")
    ...
    @ChangeSet(order = "018", id = "quarterlyClosedPipelineRevenueByTypeDC", author = "rohit")
    ...
    @ChangeSet(order = "019", id = "avgRevenueForAllAccountsDS", author = "rohit")
    ...
    @ChangeSet(order = "020", id = "avgRevenueForAllAccountsDC", author = "rohit")
    ...
    @ChangeSet(order = "021", id = "existingCustomerCountDS", author = "rohit")
    ...
    @ChangeSet(order = "022", id = "existingCustomerCountDC", author = "rohit")
    ...
    @ChangeSet(order = "023", id = "top10CustomersByRevenueDS", author = "rohit")
    ...
    @ChangeSet(order = "024", id = "top10CustomersByRevenueDC", author = "rohit")
    ...
    @ChangeSet(order = "025", id = "revenueChurnByQuarterDS", author = "rohit")
    ...
    @ChangeSet(order = "026", id = "revenueChurnByQuarterDC", author = "rohit")
    ...
    @ChangeSet(order = "027", id = "openTicketsAccountforOpenPipelineDS", author = "rohit")
    ...
    @ChangeSet(order = "028", id = "openTicketsAccountforOpenPipelineDC", author = "rohit")
    ...
    @ChangeSet(order = "029", id = "openTicketsCountByAccountDS", author = "rohit")
    ...
    @ChangeSet(order = "030", id = "openTicketsCountByAccountDC", author = "rohit")
